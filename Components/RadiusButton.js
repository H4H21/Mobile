...
class RadiusButton extends Component {
    ...
    select() {
        ...
        this.props.changeCallback(this.props.Radius);
    }
            ...
            return (
                <View style={styles.wrapper}>
                    <TouchableOpacity style={styles.buttonPressed} onPress={this.select}>
                        <Text style={styles.labelPressed}>{this.props.Radius}</Text>
                    </TouchableOpacity>
                </View>
            );
        }
        return (
            <View style={styles.wrapper}>
                <TouchableOpacity style={styles.buttonUnpressed} onPress={this.select}>
                    <Text style={styles.labelUnpressed}>{this.props.Radius}</Text>
                </TouchableOpacity>
            </View>
        );
    }
